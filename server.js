...
app.use(helmet());
app.use(cors({
  origin: process.env.FRONTEND_URL || 'https://urown-delta.vercel.app', // Use your Vercel URL
  credentials: true
}));
...
app.get('/api/articles', async (req, res) => {
  try {
    const { featured, limit = 20, offset = 0, parent_article_id, debate_topic_id } = req.query;
